...
const props = defineProps({
    // We are assuming this will pass the necessary permissions data
    permissions: Array,
});
...
const submitForm = async () => {
    try {
        // Send a POST request to the Laravel backend to create a new permission
        await axios.post('/admin/permission', form.value);

        // After successful submission, redirect the user to the permissions index page
